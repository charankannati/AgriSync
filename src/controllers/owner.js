...
module.exports = {
    ...
    registerUser: async (user) => {
        ...
        await contract.methods.registerUser(name, location, role, address).send({ from: "0xEBcE4D63d5Df0248e4E2FeF3f5930a4b6E983039", gas: 6721975})
            .then(receipt => {
    ...
    changeUserRole: async (id, role) => {
        ...
        contract.methods.changeUserRole(id, role).send({ from: ownerAddress })
            .then(receipt => {
    ...
    certifyCrop: async (cropId) => {
        ...
        contract.methods.certifyCrop(cropId).send({ from: ownerAddress })
            .then(receipt => {
